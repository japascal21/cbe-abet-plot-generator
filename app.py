...
if uploaded_file is not None:
    ...
    # patch_artist=True allows us to style box interiors
    bp = numeric_df.boxplot(ax=ax_all, patch_artist=True)
    ...
    for flier in bp["fliers"]:
        flier.set(marker="o", markerfacecolor=uconn_blue, markeredgecolor=uconn_blue, alpha=0.6, markersize=4)
