...
A small Streamlit web app that lets faculty upload an Excel file of student
grades and automatically generates box & whisker plots for each assessment,
plus a combined plot. Plots can be downloaded as PNGs for ABET documentation.
